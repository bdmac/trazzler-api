...
Fetch a trip stack as follows:
  ...
  stack = Trazzler.trip_stack(options={})
  stack.current_page
  stack.records[0].post_id

This method supports all of the trip_stack parameters supported by the Trazzler API.  Check out the documentation here: http://birdfoot.trazzler.com/about/api-docs#get-trip-stack
